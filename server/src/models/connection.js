...
export default class Connection {
    ...
    decodeMesasge(msg) {
        ...
        try {
            ...
            console.log("An error with decoding the socket mesage", msg);
        }
    ...
    sendToMembers(userId, obj) {
        ...
        this.app.db.collection('channels').aggregate(query, (err, results) => {
            ...
            if (err === null && results) {
                ...
                // this is list of all connections chatting with current user
        ...
        switch (action) {
            ...
            case 'create_message':
                ...
                if (userConnection.isAuthenticated) {
                    ...
                    this.app.models.message.create(messageObject).then((message) => {
                        ...
                        // console.log("Mesage created", message);
            ...
            case 'create_channel':
                ...
                this.app.models.channel.create(channel).then((chanelObject) => {
                    ...
                    //console.log("Succesfully created new channel", typeof userId, chanelObject);

                    // send back to all members in this channel  with new channel  created
            ...
            case 'auth':
                ...
                if (connection) {
                    ...
                    // find user with this token and verify it.
